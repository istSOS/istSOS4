...
from app.v1.endpoints.create.create import insert_location_entity, set_commit
    ...
    try:
        ...
        async with pool.acquire() as connection:
            async with connection.transaction():
                ...
                _, header = await insert_location_entity(
...
@v1.api_route(
    "/Things({thing_id})/Locations",
    methods=["POST"],
    tags=["Locations"],
    summary="Create a new Location for a Thing",
    description="Create a new Location entity for a Thing entity.",
    status_code=status.HTTP_201_CREATED,
)
